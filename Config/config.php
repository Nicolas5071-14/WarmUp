...
return [
    ...
    'menu' => [
        'main' => [
            'items' => [
                'mautic.warmup.menu.index' => [
                    'iconClass' => 'ri-fire-fill',
                    'access' => 'admin',
                    'route' => 'warmup_campaign_index',
                    'priority' => 80,
                    'children' => [
                        'mautic.warmup.domains.menu.index' => [
                            'route' => 'warmup_domain_index',
                            'iconClass' => 'fa-globe',
                            'access' => 'admin',
                        ],
                        'mautic.warmup.campaigns.menu.index' => [
                            'route' => 'warmup_campaign_index',
                            'iconClass' => 'fa-rocket',
                            'access' => 'admin',
                        ],
                        'mautic.warmup.campaigns.menu.new' => [
                            'route' => 'warmup_campaign_new',
                            'iconClass' => 'fa-plus-circle',
                            'access' => 'admin',
                        ],
                        'mautic.warmup.templates.menu.index' => [
                            'route' => 'warmup_template_index',
                            'iconClass' => 'fa-file-text',
                            'access' => 'admin',
                        ],
                        'mautic.warmup.contacts.menu.index' => [
                            'route' => 'warmup_contact_index',
                            'iconClass' => 'fa-users',
                            'access' => 'admin',
                        ],
                        'mautic.warmup.reports.menu.index' => [
    ...
    'routes' => [
        'main' => [
            ...
            // ============================================
            // ROUTES CAMPAIGN - PAGE HTML
            // ============================================
            'warmup_campaign_list_segments' => [ // NOUVELLE ROUTE
                'path' => '/warmup/campaigns/list-segments',
                'controller' => 'MauticPlugin\MauticWarmUpBundle\Controller\CampaignController::listSegmentsAction',
                'method' => 'GET'
            ],

            'warmup_campaign_preview_csv' => [ // NOUVELLE ROUTE
                'path' => '/warmup/campaigns/preview-csv',
                'controller' => 'MauticPlugin\MauticWarmUpBundle\Controller\CampaignController::previewCsvAction',
                'method' => 'POST'
            ],
            ...
            'warmup_campaign_preview_segment' => [
                'path' => '/warmup/campaigns/preview-segment',
                'controller' => 'MauticPlugin\MauticWarmUpBundle\Controller\CampaignController::previewSegmentContactsAction',
                'method' => 'POST'
            ],


            // Route pour la liste des templates (MANQUANTE)
            'warmup_template_list' => [
                'path' => '/warmup/templates/list',
                'controller' => 'MauticPlugin\MauticWarmUpBundle\Controller\TemplateController::listAction',
                'method' => 'GET'
            ],

            // Route pour charger un template spécifique
            'warmup_template_load' => [
                'path' => '/warmup/templates/load/{id}',
                'controller' => 'MauticPlugin\MauticWarmUpBundle\Controller\TemplateController::loadAction',
                'method' => 'GET'
            ],
    ...
    // Dans votre config.php, ajoutez :
    'js' => [
        'campaign_form' => [
            'path' => 'plugins/MauticWarmUpBundle/Assets/js/campaign_form.js',
            'priority' => 100,
        ],
    ],
    'services' => [
        ...
        'commands' => [
            ...
            'mautic_warmup.command.cleanup' => [
                'class' => \MauticPlugin\MauticWarmUpBundle\Command\CleanupWarmUpCommand::class,
                'arguments' => [
                    '@doctrine.orm.entity_manager',
                    '@monolog.logger.mautic'
                ],
            ...
            'mautic_warmup.command.test_email' => [
                'class' => \MauticPlugin\MauticWarmUpBundle\Command\SendTestEmailCommand::class,
                'arguments' => [
                    '@doctrine.orm.entity_manager',
                    '@mautic_warmup.service.email_sender'
                ],
